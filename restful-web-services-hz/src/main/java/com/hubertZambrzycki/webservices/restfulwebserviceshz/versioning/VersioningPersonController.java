package com.hubertZambrzycki.webservices.restfulwebserviceshz.versioning;
...
public class VersioningPersonController 
{
	...
	{
		return new PersonV2(new Name("Klaus", "Daus"));
	}
	...
	public PersonV2 getSecondVersionOfAcceptPersonHeader()
	{
		return new PersonV2((new Name("Klaus", "Daus")));
	}
